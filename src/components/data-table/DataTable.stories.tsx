...
import { DataTable, Type_DataTableProps } from "./DataTable";
...
type Type_TableData = Pick<
  (typeof jobs)[0],
  "position" | "department" | "location"
>;
type Type_TableData_Entity = Type_TableData & Type_Entity;

// Create a group of table data from our jobs array

const entry: Type_TableData_Entity[] = jobs.map(
  ({ position, department, location }) => ({
    position,
    department,
    location
...
// Create 3 columns corresponding to each field in TableData
const columns: Type_DataTableProps<Type_TableData_Entity>["columns"] = [
  { title: "Position", field: "position" },
  { title: "Department", field: "department" },
  { title: "Location", field: "location" }
];

type Story = StoryObj<typeof DataTable<Type_TableData_Entity>>;
