/* jobs handlers for jobs api endpoint
...
const getJobsHandler = rest.get(`${API_URL}/jobs`, async (req, res, ctx) => {
  const organisationId = req.url.searchParams.get("organisationId") as string;
...
export const jobsHandlers = [getJobHandler, getJobsHandler, createJobHandler];
